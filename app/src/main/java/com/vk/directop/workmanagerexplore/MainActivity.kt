...
import com.vk.directop.workmanagerexplore.ui.theme.WorkManagerExploreTheme
import java.time.Duration

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
//        val downloadRequest = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
//            PeriodicWorkRequestBuilder<DownloadWorker>(
//                Duration.ofHours(5)
//            )
//        } else {
//            //("VERSION.SDK_INT < O")
            ...
            WorkManagerExploreTheme {
                ...
                Column(
                    ...
                    when(downloadInfo?.state){
                        ...
                        WorkInfo.State.CANCELLED -> Text("Download canceled")
                    ...
                    when(filterInfo?.state){
                        ...
                        WorkInfo.State.CANCELLED -> Text("Filter canceled")
